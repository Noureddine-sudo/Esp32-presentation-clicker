...
3. Make sure your presentation server is running and advertising as `serveur-pres.local` (better run the server in a linux vm cause of the problems of mDns in windows11)
...
And should advertise itself via mDNS as `serveur-pres.local`.# Iot_Project
;;
