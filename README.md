...
3. Make sure your presentation server is running and advertising as `serveur-pres.local` better use the ser.py in a linux vm cause of the problems of mDns in windows 11
